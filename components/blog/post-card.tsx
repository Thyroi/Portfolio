    ...
    <Link href={`/blog/${post.slug}`} className="block h-full">
      <Card className="h-full border-slate-900/10 bg-white/88 transition-transform duration-200 hover:-translate-y-1 hover:ring-slate-900/20">
        <CardHeader className="flex-1 content-start">
          ...
          <CardDescription className="overflow-hidden text-ellipsis leading-7 [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:4]">
            {post.description}
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="mt-auto justify-between text-sm text-slate-500">
