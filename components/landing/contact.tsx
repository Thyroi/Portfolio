      ...
      <div className="grid gap-6 rounded-[2.5rem] border border-white/10 bg-slate-950/74 p-8 shadow-[0_30px_90px_rgba(2,8,23,0.35)] backdrop-blur sm:p-12 lg:grid-cols-[1fr_0.75fr]">
        <div className="space-y-4">
          ...
          <p className="max-w-2xl text-base leading-7 text-slate-300">
            This scaffold is ready for your real profile details, projects, and production content.
            For now, the callouts below are placeholders with working structure and responsive
            layout.
          </p>
        </div>
